...
- **Removed the `brand-bar`** (a hardcoded `assets/logo.svg` plus a "Senior AI Engineer"
  label) from both compositions. It stamped the original author's branding onto every video
