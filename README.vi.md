...
| 🎨 **Theme đổi màu** | [Bản paper-blue](examples/ai-video-social/sample-output-paper-blue/) — 16 scene, dùng 14 trong số 129 template, đổi sang nền trắng chữ xanh biển qua `"theme": "paper-blue"` |
...
| `video-templates/` | 129 template video HTML một-file cùng **`CATALOG.md`** — mỗi template tự chứa CSS và animation, render offline mượt mà. 176 template nữa chỉ cách một câu lệnh. |
...
| **129 template, 12 thể loại** | Hỗ trợ 12 thể loại video: Review, Hướng dẫn, Tin tức, Listicle, Ra mắt, Testimonial, Local GEO, Vox Explainer, Toán học, Kiến trúc, Du lịch |
