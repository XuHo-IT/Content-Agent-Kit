...
| Path | Purpose |
|---|---|
| `docs/` | The methodology, bilingual EN + VI, 16 short documents — including **`12-writing-craft.md`**, `14-video-generation.md`, **`15-media-sources.md`** (B-roll and screenshots) and **`16-template-registry.md`**. |
...
| `video-templates/` | 14 self-contained HTML video templates plus **`CATALOG.md`** — every slot and character limit. 146 more are one command away. |
